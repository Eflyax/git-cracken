<template>
	<div class="flex overflow-hidden">
		...
		<div
			v-if="parts.length > 2"
			class="opacity-65 shrink-[100000000] ellipsis min-w-5"
		>
			{{ parts[0] }}
		</div>
		<div v-if="parts.length > 2" class="opacity-65 shrink-0">/</div>
		<div
			v-if="parts.length > 1"
			class="opacity-65 shrink-[10000] ellipsis [direction:rtl]"
		>
